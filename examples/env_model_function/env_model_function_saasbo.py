...
for trial in range(n_trials):
    ...
    # Definition the BO optimizers using the SAAS prior GP models
    autoencoder = MLPAutoEnc(high_dim=ydoe.shape[-1], hidden_dims=[256,64], zd = 5, activation = torch.nn.SiLU())
...
results = {"BO_EI": {"objectives": boei_objectives, "design": boei_dvs, "doe": boei_doe, "time": boei_t, "lengthscales": boei_lengthscales}, 
	"BO_LOGEI": {"objectives": bologei_objectives, "design": bologei_dvs, "doe": bologei_doe, "time": bologei_t, "lengthscales": bologei_lengthscales}, 
           "ROMBO_EI": {"objectives": romboei_objectives, "design": romboei_dvs, "doe": romboei_doe, "time": romboei_t,"lengthscales": romboei_lengthscales}, 
	"ROMBO_LOGEI": {"objectives": rombologei_objectives, "design": rombologei_dvs, "doe": rombologei_doe, "time": rombologei_t,"lengthscales": rombologei_lengthscales}}
savemat("./env_model_results_{}_{}_optimizer{}_saasbo_trial_{}.mat".format(args.input_dim, args.output_dim, args.optimizer, args.trial_num), results)
