...
for trial in range(n_trials):
    ...
    rom_args = {"ric": 0.9999, "low_dim_model": SingleTaskGP, "low_dim_likelihood": ExactMarginalLogLikelihood,
                "saas": False}
...
savemat("/scratch/gilbreth/adikshit/env_model_results_{}_{}_POD_BO_trial_{}_MC_{}.mat".format(args.input_dim, args.output_dim, args.trial_num, args.mc_samples), results)
